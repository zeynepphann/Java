...
public class C03_MDArrays {
    public static void main(String[] args) {
        ...
        // bir ilcede her birinde 24 ograncilik 8 sinif bulunan 5 okul vardir


        int ilce [][][]= new int[5][8][24];

        // bir okulda 3 tane 24 kiişilil 2 tane de 22 kisilik sinif vardir

        int sinif24[][]=new int[3][24];
        int sinif22[][]=new int[2][22];

        // olustururken elementleri atama yaparsak farkli uzunlukta inner arrayler tanimlayabiliriz

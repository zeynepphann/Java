...
public class C02_ListeyiDuzenliYazdirma {
    public static void main(String[] args) {
        //sinif listesini duzenli bbir sekilde yazdirmak
    ...
    public static void sinifListYazdir(Map<Integer, String> sinif) {
        ...
        //mapde'ki datalari, istedigimiz formata sokmamiz gerekir
        //1.adim key ve value'lari map'den alip iki farkli
        //collection uyesine atadik
        Set<Integer>keySet=sinif.keySet();
        Collection< String > valueSet=sinif.values();
        // Set< String > valueSet1=(Set) sinif.values();
